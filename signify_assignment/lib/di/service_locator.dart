...
Future<void> setupLocator() async {
  ...
  getIt.registerFactory<QuoteRepository>(() => QuoteRepositoryImpl(
      apiClient: getIt(), apiService: getIt(), localStorage: getIt()));
  getIt.registerFactory<GetQuotesUseCase>(
      () => GetQuotesUseCase(repository: getIt()));
